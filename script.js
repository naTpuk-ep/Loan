...
/* harmony import */ var _modules_accordeon__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/accordeon */ "./src/js/modules/accordeon.js");
...
/* harmony import */ var _modules_slider_pageSlider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/slider/pageSlider */ "./src/js/modules/slider/pageSlider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  new _modules_slider_pageSlider__WEBPACK_IMPORTED_MODULE_6__["default"]({
    container: '.page',
    next: '.next'
  }).render();
  new _modules_slider_pageSlider__WEBPACK_IMPORTED_MODULE_6__["default"]({
  ...
  player1.init();
  var player2 = new _modules_playVideo__WEBPACK_IMPORTED_MODULE_0__["default"]('.module__video-item .play', '.overlay');
  player2.init();
  new _modules_difference__WEBPACK_IMPORTED_MODULE_2__["default"]('.difference__info-cards').init();
  new _modules_form__WEBPACK_IMPORTED_MODULE_3__["default"]('.form').init();
  new _modules_accordeon__WEBPACK_IMPORTED_MODULE_4__["default"]('.plus').init();
    ...
    value: function init() {
      try {
        this.triggers.forEach(function (trigger) {
          var msg = trigger.closest('.module__info-show').nextElementSibling;
          msg.style.cssText = "\n\t\t\t\tdisplay: block;\n\t\t\t\tmax-height: 0px;\n\t\t\t\toverflow: hidden;\n\t\t\t\ttransition: 0.5s ease;\n\t\t\t\topacity: 0;\n\t\t\t\t";
          trigger.addEventListener('click', function () {
            if (msg.style.maxHeight == '0px') {
              trigger.querySelector('path').style.display = 'none';
              msg.style.maxHeight = "".concat(msg.scrollHeight, "px");
              msg.style.opacity = 1;
            } else {
...
function () {
  ...
  _createClass(Difference, [{
    key: "bind",
    value: function bind(item, items, offIndex) {
      var _this = this;

      item.querySelector('.plus').addEventListener('click', function () {
        items[_this.counter[offIndex]].style.display = 'flex';
        var mTop = window.getComputedStyle(item).marginTop;
        item.style.marginTop = "-".concat(window.getComputedStyle(item).height);
        _this.counter[offIndex]++;
        setTimeout(function () {
          items[_this.counter[offIndex] - 1].style.opacity = '1';
      ...
      item.addEventListener('transitionend', function () {
        ...
        if (_this.counter[offIndex] === items.length - 1) {
          item.remove();
        }
    ...
    value: function hide() {
      ...
      this.officers.forEach(function (officer, offIndex) {
        _this2.counter[offIndex] = 1;
        officer.children.forEach(function (item, i, items) {
          ...
          if (i === items.length - 1) {
            _this2.bind(item, items, offIndex);
          }
    ...
    value: function mask() {
      ...
      function createMask(event) {
        ...
        this.value.split('').forEach(function (a, index) {
          ...
          if (i < 5) i = _this.value.indexOf('_');
        });
    ...
    value: function init() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          ...
          _this2.postData(_this2.path, formData).then(function (resp) {
            console.log(resp);
  ...
  _createClass(VideoPlayer, [{
        ...
        btn.addEventListener('click', function () {
          if (!btn.closest('.module__video-item') || btn.closest('.module__video-item').getAttribute('data-disabled') !== 'true') {
            ...
            if (document.querySelector('iframe#frame')) {
              ...
              _this.createPlayer(_this.path, true);
            }
          }
        });
      });
    ...
    value: function onPlayerStateChange(state) {
      try {
        ...
        var playBtn = this.activeBtn.querySelector('svg').cloneNode(true); //глубокое копирование

        if (state.data === 0) {
          this.closePlayer();
          if (blockedElem.querySelector('.play__circle').classList.contains('closed')) blockedElem.querySelector('.play__circle').classList.remove('closed');
...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, activeClass, animate, auto) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, activeClass, animate, auto));
  }
  ...
  _createClass(MiniSlider, [{
    ...
    key: "decorizeSlides",
    value: function decorizeSlides(index) {
      var _this2 = this;
    ...
    value: function showPrev() {
      ...
      this.slides[0].style.marginLeft = "-".concat(parseInt(window.getComputedStyle(this.slides[1]).width) + parseInt(window.getComputedStyle(this.slides[1]).marginRight), "px");
      this.decorizeSlides(1);
      this.slides[0].addEventListener('transitionend', function () {
        _this3.container.insertBefore(_this3.slides[0], _this3.container.querySelector('button'));

        var active;

        if (_this3.container.querySelector('button')) {
          active = _this3.container.querySelector('button').previousElementSibling;
        } else {
    ...
    value: function showNext() {
      ...
      active.style.marginLeft = "-".concat(parseInt(window.getComputedStyle(active).width) + parseInt(window.getComputedStyle(active).marginRight), "px");
      this.container.insertBefore(active, this.slides[0]);
      setTimeout(function () {
        _this4.slides[0].style.marginLeft = '0px';

        _this4.decorizeSlides(0);
      });
    }
  }, {
    key: "bindTriggers",
    value: function bindTriggers() {
      ...
      try {
        this.container.closest('.modules').previousElementSibling.addEventListener('transitionend', function () {
          _this5.autoNext();
        });
      } catch (e) {}
...
/***/ "./src/js/modules/slider/pageSlider.js":
/*!*********************************************!*\
  !*** ./src/js/modules/slider/pageSlider.js ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PageSlider; });
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.symbol */ "./node_modules/core-js/modules/es.symbol.js");
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.symbol.description */ "./node_modules/core-js/modules/es.symbol.description.js");
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__);
...
/*#__PURE__*/
function (_Slider) {
  _inherits(PageSlider, _Slider);

  function PageSlider(next, prev) {
    _classCallCheck(this, PageSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(PageSlider).call(this, next, prev));
  }

  _createClass(PageSlider, [{
    key: "hansonShow",
    value: function hansonShow() {
      var _this = this;
    ...
    value: function startShow() {
      ...
      this.slides[0].style.marginTop = "-".concat(window.getComputedStyle(this.slides[0]).height);
      this.slides[1].style.display = 'block';
      this.firstSlide = this.slides[1];
    }
  }, {
    key: "showNextSlides",
    value: function showNextSlides(auto) {
      var _this2 = this;

      this.slides[0].style.display = 'block';
      this.slides[2].style.display = 'block';
      this.slides[0].style.marginTop = "-".concat(2 * parseFloat(window.getComputedStyle(this.slides[0]).height), "px");
      this.slides[0].addEventListener('transitionend', function () {
        _this2.container.appendChild(_this2.slides[0]);

        _this2.slides[0].style.display = 'none';
        _this2.slides[0].style.marginTop = "-".concat(window.getComputedStyle(_this2.slides[0]).height);
        _this2.slides[_this2.slides.length - 1].style.display = 'none';
        _this2.slides[_this2.slides.length - 1].style.marginTop = '0px';

        if (auto & _this2.slides[1] != _this2.firstSlide) {
          return _this2.showNextSlides(true);
        } else {
    ...
    value: function showPrevSlide() {
      ...
      this.slides[this.slides.length - 1].style.marginTop = "-".concat(2 * parseFloat(window.getComputedStyle(this.slides[this.slides.length - 1]).height), "px");
      this.slides[0].style.display = 'block';
      this.slides[2].style.display = 'block';
      this.container.prepend(this.slides[this.slides.length - 1]);
      this.slides[0].style.display = 'block';
      setTimeout(function () {
        _this3.slides[0].style.marginTop = "-".concat(window.getComputedStyle(_this3.slides[0]).height);
      });
      this.slides[0].addEventListener('transitionend', function () {
        _this3.slides[0].style.display = 'none';
        _this3.slides[2].style.display = 'none';
        _this3.slides[3].style.display = 'none';
      }, {
        once: true
      });
    }
        ...
        if (btn.parentNode.previousElementSibling.tagName == 'A') {
          btn.parentNode.previousElementSibling.addEventListener('click', function (e) {
            if (btn.closest('.page')) {
              ...
              if (_this4.slides[1] != _this4.firstSlide) {
                var sek = 0.2;

                _this4.slides.forEach(function (slide, i) {
                  if (i != 0) {
                    sek < 0.1 ? sek = 0.1 : sek;
                    slide.style.transition = "all linear ".concat(sek -= 0.04, "s");
                  }
                });

                _this4.showNextSlides(true);
              }
            } else {
